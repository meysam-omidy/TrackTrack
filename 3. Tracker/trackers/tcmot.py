...
class Tracker(object):
    ...
    def init_tracks(self, dets):
        ...
        iou_sim = iou_distance(tracks + dets, tracks + dets)[1]
    ...
    def update(self, dets, dets_95):
        ...
        matches, u_tracks, u_dets = iterative_assigment(tracked_lost, dets_high, dets_low, dets_del_high,
                                                        self.args.match_thr, self.args.penalty, self.args.reduce_step,
                                                        self.frame_id)
        ...
        matches, u_tracks, u_dets = iterative_assigment(new, dets_high_left, [], [], self.args.match_thr,
                                                        self.args.penalty, self.args.reduce_step, self.frame_id)
